  ...
  return (
    <div id="projects" className={styles.block}>
      ...
      <div id={styles.middle} className={styles["project-card"]}>
        <div className={`${styles["project-details-left"]} ${styles["project-details"]}`}>
          <h2>Github Follawers API</h2>
          <p>
