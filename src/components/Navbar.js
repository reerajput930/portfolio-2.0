          ...
          <nav className={`myDiv ${isMenuOpen ? 'show' : ''}`} >
            <div className="navbar-menu">
              <ul style={{ display: "flex",flexDirection:"column" }} className={style.ulstyle}>
                ...
                <li>
                  <a onClick={()=> handleMenuToggle()} href="#skills--section"> <h2><span className={style.colored}>02.</span>Skills</h2></a>
                </li>
                <li>
                  <a onClick={()=> handleMenuToggle()} href="#experence"> <h2><span className={style.colored}>03.</span>Experience</h2></a>
                </li>
                <li>
                  <a onClick={()=> handleMenuToggle()} href="#projects"> <h2><span className={style.colored}>04.</span>Projects</h2></a>
                </li>
